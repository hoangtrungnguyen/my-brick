...
extends _${{name.pascalCase()}}StateCopyWithImpl<$Res, _$InitialImpl>
...
@override
String toString() {
return '{{name.pascalCase()}}State(name: $name)';
}
...
@JsonKey(ignore: true)
@override
@pragma('vm:prefer-inline')a
_$$InitialImplCopyWith<_$InitialImpl> get copyWith =>
__$$InitialImplCopyWithImpl<_$InitialImpl>(this, _$identity);
}

abstract class Initial extends {{name.pascalCase()}}State {
